...
![image-20201220213306128](docker文档/image-20201220213306128.png)

![image-20201220214210994](docker文档/image-20201220214210994.png)
...
![image-20201220222456675](docker文档/image-20201220222456675.png)
...
![image-20200404111908085](docker文档/image-20200404111908085-0291323.png)
...
![image-20200404120356784](docker文档/image-20200404120356784.png)
...
sudo tee /etc/docker/daemon.json <<-'EOF'
{
  "registry-mirrors": ["https://1sbuq3iu.mirror.aliyuncs.com"]
}
EOF
sudo systemctl daemon-reload
sudo systemctl restart docker
...
![image-20200404142950068](docker文档/image-20200404142950068.png)
...
可以参考这个进行进一步的设置，比如设置远程连接： https://blog.csdn.net/qq_42971035/article/details/127831101
...
- 启动出现如下错误
- ![image-20200602184321790](docker文档/image-20200602184321790.png)
...
![1668926575569](docker文档/1668926575569.png)
...
![image-20200602183429286](docker文档/image-20200602183429286.png)
...
![image-20200602183718623](docker文档/image-20200602183718623.png)
...
![image-20200404111908085](docker文档/image-20200404111908085.png)

- **通过架构图可以看出通过DockerFile可以直接构建镜像**

### 9.2 Dockerfile解析过程

![image-20200603181253804](docker文档/image-20200603181253804.png)
...
![image-20200605172151266](docker文档/image-20200605172151266.png)

##### 2.将可运行项目放入linux虚拟机中

![image-20200605172340380](docker文档/image-20200605172340380.png)
...
![image-20200605173141636](docker文档/image-20200605173141636.png)
...
![image-20201125105847896](docker文档/image-20201125105847896.png)
...
![image-20201223231707738](docker文档/image-20201223231707738.png)
...
## 1. WARNING: IPv4 forwarding is disabled. Networking will not work. 无法访问ipv4

[root@castile ~]# docker run -p 8080:8080 -v /root/webapps:/usr/local/tomcat/webapps -d --name mytomcat tomcat:8.0.53
WARNING: IPv4 forwarding is disabled. Networking will not work.
61464b009339e82adf1f81c3dbabea1c4910b037006a2d2666e28b4706f4b3a6
...
![1668926163225](docker文档/1668926163225.png)
