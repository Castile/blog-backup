...
![1717685526053](MySQL实战45讲精华/1717685526053.png)
...
对于唯一索引来说，所有的更新操作都要先判断这个操作是否违反**唯一性约束**，这样就必须要将数据页读入内存中才能判断，这就没必要使用`change buffer`
...
![change buffer 的读过程 ](MySQL实战45讲精华/1717687061080.png)
